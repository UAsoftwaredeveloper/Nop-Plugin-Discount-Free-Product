...
namespace Nop.Services.Seo
{
    ...
    public partial class UrlRecordService : IUrlRecordService
    {
        ...
        /// Gets an URL records
        /// </summary>
        /// <param name="urlRecordId">URL record identifiers</param>
        /// <returns>
        /// A task that represents the asynchronous operation
        /// The task result contains the uRL record
        /// </returns>
        public virtual async Task<UrlRecord> GetUrlRecordsByIdAsync(int urlRecordId)
        {
        ...
        /// The task result contains the found slug
        /// </returns>
        public virtual async Task<string> GetActiveSlugAsync(int entityId)
        {
            //gradual loading
            var key = _staticCacheManager.PrepareKeyForDefaultCache(NopSeoDefaults.UrlRecordCacheKey, entityId);
