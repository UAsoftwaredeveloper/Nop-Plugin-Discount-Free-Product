...
namespace Nop.Services.Discounts
{
    ...
    public partial interface IDiscountService
    {
        ...
        Task<IList<DiscountCategoryMapping>> GetAllDiscountCatgoryMappingsAsync();
        /// <summary>
        /// Get All Discount Mappings
        /// </summary>
        /// <returns>A task that represents the asynchronous operation</returns>

        Task<IList<DiscountMapping>> GetAllDiscountMappingsAsync();
        /// <summary>
        ...
        Task<(int, string)> GetEntityIdByDiscountIdAsync(int discountId);
        #endregion
