...
namespace Nop.Web.Areas.Admin.Models.Discounts
{
    ...
    public partial record DiscountModel : BaseNopEntityModel
    {
        ...
        [UIHint("Picture")]
        [NopResourceDisplayName("Admin.Promotions.Discounts.Fields.Picture")]
        public int PictureId { get; set; }
        [UIHint("Picture")]
        [NopResourceDisplayName("Admin.Promotions.Discounts.Fields.HotDealPictureId")]
        public int HotDealPictureId { get; set; }
        [NopResourceDisplayName("Admin.Promotions.Discounts.Fields.HotDeal")]
        public bool IsHotDeal { get; set; }
        [NopResourceDisplayName("Admin.Promotions.Discounts.Fields.BestDeal")]
        public bool IsBestDeal { get; set; }
        [NopResourceDisplayName("Admin.Promotions.Discounts.Fields.DisplayOnHomePage")]
