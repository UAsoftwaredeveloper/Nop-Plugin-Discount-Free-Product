...
namespace Nop.Plugin.Misc.MySms
{
    ...
    public class MySmsPlugin : BasePlugin, IMiscPlugin
    {
        ...
        public override async Task InstallAsync()
        {
            ...
            {
                ApiUrl = "Enter Your Api URL",
                ContentType= "application/x-www-form-urlencoded",
                Authorization= "Bg0MmxKWdRz286OChVvy4pcJaNwj713otkqGneT5YDiHuUZQbFBMWPgbel9kXTKZ1yju50QtcEdL836f",
                Enable =false,
               
            }); ;
            //await _settingService.SaveSettingAsync(new SmsConfigurationManager());
            _widgetSettings.ActiveWidgetSystemNames.Add(MySmsDefaults.SystemName);
        ...
        public override async Task UninstallAsync()
        {
            ...
            if (_widgetSettings.ActiveWidgetSystemNames.Contains(MySmsDefaults.SystemName))
            {
                _widgetSettings.ActiveWidgetSystemNames.Remove(MySmsDefaults.SystemName);
                await _settingService.SaveSettingAsync(_widgetSettings);
            }
